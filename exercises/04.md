...
> - A két koordináta-rendszerbeli pontot kérd be `double` típusú változókba, majd az irányvektorokat kiszámolva a skalárszorzatuk 0 volta jelzi a merőlegességet.
>   - Ha feltesszük, hogy a pontok koordinátái: `(a1, a2), (b1, b2)` és `(c1, c2), (d1, d2)`, akkor a kérdéses skalárszorzat `(a1-b1)*(c1-d1) + (a2-b2)*(c2-d2)`.
>   - Figyelj rá, hogy lebegőpontos számábrázolásnál nem hasonlítunk össze az `==` operátorral!
