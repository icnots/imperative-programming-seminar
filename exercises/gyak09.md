...
- A fájl megnyitás/írás/olvasáshoz és az `fgets` használatához: [Fájlkezelés](./demo09.md)
...
1. Írj programot, amely beolvas egy stringet a standard inputról, és megszámolja benne a betűk, a karakterek és a szavak számát! A beolvasáshoz használd az `fgets()` függvényt.
2. Írj programot, amely beolvas egy második stringet, és összehasonlítja az előzővel! A feladatot végezd el beépített művelettel is a `string.h` könyvtárból (`strcmp`).
3. Másold le az előző stringet egy harmadik stringbe! A feladatot végezd el beépített művelettel is (`strcpy`).
