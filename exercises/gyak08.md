...
- Leírás a fájlokra tagolásról: [Fájlokra tagolás, modulok](./demo08.md)

### Demó feladat

Készíts egy programot, amely visszafelé fog számolni egy előre megadott számtól.
A `main` program parancssori argumentumként megkapott számtól számoljon visszafelé úgy, hogy mindig kiírja, hogy az adott szám páros vagy páratlan, majd meghívja a másik függvényt (0-nál lépjen ki.)
Ez úgy történjen, hogy legyen egy `even` és egy `odd` nevű függvény, amely a megadott szavakkal kiírja a számot, majd az "even" vagy "odd" szót.
Először készítsük el egy fájlba a programot, majd rakjuk külön fordítási egységbe mindhárom függvényt és készítsünk az `even` és `odd` függvényeknek külön-külön header fájlt!
